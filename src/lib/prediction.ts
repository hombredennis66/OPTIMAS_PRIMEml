...
export function predictSpending(
  ...
  const contributions: Contribution[] = [
    { feature: "intercept", label: "Baseline", value: c.intercept },
    {
      ...
      value: c.allowance * input.monthly_allowance,
    },
    {
      feature: "distance_from_campus",
      label: "Distance from campus",
      value: c.distance * input.distance_from_campus,
    },
    {
      feature: "accommodation_type",
      label: `Accommodation (${input.accommodation_type})`,
      value: c.accommodation[input.accommodation_type],
    },
    {
      feature: "transport_type",
      label: `Transport (${input.transport_type})`,
      value: c.transport[input.transport_type],
    },
    {
      feature: "meal_habits",
      label: `Meal habits (${input.meal_habits})`,
      value: c.meal[input.meal_habits],
    },
    ...
    {
      feature: "printing_frequency",
      label: "Printing",
      value: c.printing * input.printing_frequency,
    },
  ];
